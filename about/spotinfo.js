	...
	fetch(`${serviceHost}/get-now-playing`)
		...
		.then((data) => {
			if (data.hasOwnProperty("ERROR")) {
				...
				document.getElementById("songinfocontent").setAttribute("style", "margin-bottom: 0px;");
				...
				document.getElementById("songinfocontent").setAttribute("style", "margin-bottom: 10px;");
			}
